 ...
 * @export
 * @interface IndividualCreate
 */
export interface IndividualCreate {
    /**
     * e.g. Baron, Graf, Earl,…
     * @type {string}
     * @memberof IndividualCreate
     */
...
/**
 * Check if a given object implements the IndividualCreate interface.
 */
export function instanceOfIndividualCreate(value: object): value is IndividualCreate {
...
export function IndividualCreateFromJSON(json: any): IndividualCreate {
    return IndividualCreateFromJSONTyped(json, false);
}

export function IndividualCreateFromJSONTyped(
    json: any,
...
export function IndividualCreateToJSON(json: any): IndividualCreate {
    return IndividualCreateToJSONTyped(json, false);
}

export function IndividualCreateToJSONTyped(
    value?: IndividualCreate | null,
