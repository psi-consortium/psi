...
@Validated
@Tag(name = "ProductTemplate", description = "Operations for ProductTemplate Resource")
public interface ProductTemplateApi {

    /**
     * POST /productTemplate : Creates a ProductTemplate
     * This operation creates a ProductTemplate entity.
     *
    ...
    ResponseEntity<ProductSpecification> createProductTemplate(
    ...
    /**
     * DELETE /productTemplate/{id} : Deletes a ProductTemplate
     * This operation deletes a ProductTemplate entity.
     *
    ...
    ResponseEntity<Void> deleteProductTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id
    );


    /**
     * GET /productTemplate : List or find ProductTemplate objects
     * List or find ProductTemplate objects
     *
    ...
    ResponseEntity<List<ProductSpecification>> listProductTemplate(
        @Parameter(name = "filter", description = "Properties for filtering resources to be returned to the response", hidden = true) @Valid Optional<ProductTemplateFilter> filter,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields,
    ...
    /**
     * PATCH /productTemplate/{id} : Updates partially a ProductTemplate
     * This operation updates partially a ProductTemplate entity.
     *
     * @param id Identifier of the Resource (required)
    ...
    ResponseEntity<ProductSpecification> patchProductTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
    ...
    /**
     * GET /productTemplate/{id} : Retrieves a ProductTemplate by ID
     * This operation retrieves a ProductTemplate entity. Attribute selection enabled for all first level attributes.
     *
     * @param id Identifier of the Resource (required)
     * @param fields Comma-separated properties to be provided in response (optional)
     * @return Success (status code 200)
    ...
    ResponseEntity<ProductSpecification> retrieveProductTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields
    );
