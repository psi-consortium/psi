...
@Validated
@Tag(name = "ResourceTemplate", description = "Operations for ResourceTemplate Resource")
public interface ResourceTemplateApi {

    /**
     * POST /resourceTemplate : Creates a ResourceTemplate
     * This operation creates a ResourceTemplate entity.
     *
    ...
    ResponseEntity<ResourceSpecification> createResourceTemplate(
    ...
    /**
     * DELETE /resourceTemplate/{id} : Deletes a ResourceTemplate
     * This operation deletes a ResourceTemplate entity.
     *
    ...
    ResponseEntity<Void> deleteResourceTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id
    );


    /**
     * GET /resourceTemplate : List or find ResourceTemplate objects
     * List or find ResourceTemplate objects
     *
    ...
    ResponseEntity<List<ResourceSpecification>> listResourceTemplate(
        @Parameter(name = "filter", description = "Properties for filtering resources to be returned to the response", hidden = true) @Valid Optional<ResourceTemplateFilter> filter,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields,
    ...
    /**
     * PATCH /resourceTemplate/{id} : Updates partially a ResourceTemplate
     * This operation updates partially a ResourceTemplate entity.
     *
     * @param id Identifier of the Resource (required)
    ...
    ResponseEntity<ResourceSpecification> patchResourceTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
    ...
    /**
     * GET /resourceTemplate/{id} : Retrieves a ResourceTemplate by ID
     * This operation retrieves a ResourceTemplate entity. Attribute selection enabled for all first level attributes.
     *
     * @param id Identifier of the Resource (required)
     * @param fields Comma-separated properties to be provided in response (optional)
     * @return Success (status code 200)
    ...
    ResponseEntity<ResourceSpecification> retrieveResourceTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields
    );
