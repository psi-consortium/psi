...
@Validated
@Tag(name = "PerformanceJobComplexQuery", description = "Performance Monitoring Job API")
public interface PerformanceJobComplexQueryApi {

    /**
     * POST /performanceJobComplexQuery : Creates a PerformanceJobComplexQuery.
     * A request initiated by the Buyer/Client to create  a Performance Monitoring Job Complex Query in the Seller/Server system.
     *
     * @param performanceJobComplexQueryCreate The PerformanceJobComplexQuery to be created. (required)
    ...
    @Operation(
        ...
        tags = { "performanceJobComplexQuery" },
        responses = {
            @ApiResponse(responseCode = "200", description = "'OK. (https://tools.ietf.org/html/rfc7231#section-6.3.1)'", content = {
                @Content(mediaType = "application/json;charset=utf-8", schema = @Schema(implementation = PerformanceJobComplexQuery.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/performanceJobComplexQuery",
        produces = "application/json;charset=utf-8",
        consumes = "application/json;charset=utf-8"
    )
    ResponseEntity<List<PerformanceJobComplexQuery>> createPerformanceJobComplexQuery(
        @Parameter(name = "PerformanceJobComplexQueryCreate", description = "The PerformanceJobComplexQuery to be created.", required = true) @Valid @RequestBody PerformanceJobComplexQueryCreate performanceJobComplexQueryCreate
    );
