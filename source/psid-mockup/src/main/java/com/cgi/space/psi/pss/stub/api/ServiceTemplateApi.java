...
@Validated
@Tag(name = "ServiceTemplate", description = "Operations for ServiceTemplate Resource")
public interface ServiceTemplateApi {

    /**
     * POST /serviceTemplate : Creates a ServiceTemplate
     * This operation creates a ServiceTemplate entity.
     *
    ...
    ResponseEntity<ServiceSpecification> createServiceTemplate(
    ...
    /**
     * DELETE /serviceTemplate/{id} : Deletes a ServiceTemplate
     * This operation deletes a ServiceTemplate entity.
     *
    ...
    ResponseEntity<Void> deleteServiceTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id
    );


    /**
     * GET /serviceTemplate : List or find ServiceTemplate objects
     * List or find ServiceTemplate objects
     *
    ...
    ResponseEntity<List<ServiceSpecification>> listServiceTemplate(
        @Parameter(name = "filter", description = "Properties for filtering resources to be returned to the response", hidden = true) @Valid Optional<ServiceTemplateFilter> filter,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields,
    ...
    /**
     * PATCH /serviceTemplate/{id} : Updates partially a ServiceTemplate
     * This operation updates partially a ServiceTemplate entity.
     *
     * @param id Identifier of the Resource (required)
    ...
    ResponseEntity<ServiceSpecification> patchServiceTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
    ...
    /**
     * GET /serviceTemplate/{id} : Retrieves a ServiceTemplate by ID
     * This operation retrieves a ServiceTemplate entity. Attribute selection enabled for all first level attributes.
     *
     * @param id Identifier of the Resource (required)
     * @param fields Comma-separated properties to be provided in response (optional)
     * @return Success (status code 200)
    ...
    ResponseEntity<ServiceSpecification> retrieveServiceTemplate(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields
    );
