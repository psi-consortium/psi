...
@Validated
@Tag(name = "CustomerBill", description = "Operations for CustomerBill Resource")
public interface CustomerBillApi {

    /**
     * POST /customerBill : Creates a CustomerBill
     * This operation creates a CustomerBill entity.
     *
     * @param customerBillFVO The CustomerBill to be created. (required)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "OK/Created", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerBill.class))
            }),
    ...
    ResponseEntity<CustomerBill> createCustomerBill(
        @Parameter(name = "CustomerBillFVO", description = "The CustomerBill to be created.", required = true) @Valid @RequestBody CustomerBillFVO customerBillFVO,
    ...
    /**
     * DELETE /customerBill/{id} : Deletes a CustomerBill
     * This operation deletes a CustomerBill entity.
     *
    ...
    @RequestMapping(
        ...
        value = "/customerBill/{id}",
        produces = "application/json"
    )
    ResponseEntity<Void> deleteCustomerBill(
    ...
    ResponseEntity<List<CustomerBill>> listCustomerBill(
        @Parameter(name = "filter", description = "Properties for filtering resources to be returned to the response", hidden = true) @Valid Optional<CustomerBillFilter> filter,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields,
     ...
     *
     * @param id Identifier of the Resource (required)
     * @param customerBillMVO The CustomerBill to be patched (required)
     * @param fields Comma-separated properties to be provided in response (optional)
     * @return Success (status code 200)
     *         or Accepted (status code 202)
     *         or Bad Request (status code 400)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CustomerBill.class)),
                @Content(mediaType = "application/merge-patch+json", schema = @Schema(implementation = CustomerBill.class)),
                @Content(mediaType = "application/json-patch+json", schema = @Schema(implementation = CustomerBill.class)),
                @Content(mediaType = "application/json-patch-query+json", schema = @Schema(implementation = CustomerBill.class))
            }),
            @ApiResponse(responseCode = "202", description = "Accepted"),
            @ApiResponse(responseCode = "400", description = "Bad Request", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class)),
    ...
    ResponseEntity<CustomerBill> patchCustomerBill(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
        @Parameter(name = "CustomerBillMVO", description = "The CustomerBill to be patched", required = true) @Valid @RequestBody CustomerBillMVO customerBillMVO,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields
    );
     ...
     * This operation retrieves a CustomerBill entity. Attribute selection enabled for all first level attributes.
     *
     * @param id Identifier of the Resource (required)
     * @param fields Comma-separated properties to be provided in response (optional)
     * @return Success (status code 200)
    ...
    ResponseEntity<CustomerBill> retrieveCustomerBill(
        @Parameter(name = "id", description = "Identifier of the Resource", required = true) @PathVariable("id") String id,
        @Parameter(name = "fields", description = "Comma-separated properties to be provided in response") @Valid @RequestParam(value = "fields", required = false) Optional<String> fields
    );
