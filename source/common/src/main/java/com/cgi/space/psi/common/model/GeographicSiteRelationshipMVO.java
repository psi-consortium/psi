...
@JsonSubTypes({
  @JsonSubTypes.Type(value = GeographicSiteRelationshipMVO.class, name = "GeographicSiteRelationship")
})

@JsonTypeName("GeographicSiteRelationship_MVO")
...
public class GeographicSiteRelationshipMVO {
  ...
  */
  ...
  public GeographicSiteRelationshipMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public GeographicSiteRelationshipMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public GeographicSiteRelationshipMVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  @Valid 
  @Schema(name = "href", description = "Reference of the related geographic site", required = false)
  public URI getHref() {
    return href;
  }
  ...
  public GeographicSiteRelationshipMVO role(String role) {
    this.role = role;
    return this;
  }
  ...
  */
  ...
  @Schema(name = "role", description = "Role of the related site in the relationship", required = false)
  ...
  public GeographicSiteRelationshipMVO validFor(TimePeriod validFor) {
  ...
  */
  ...
  public GeographicSiteRelationshipMVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  @Schema(name = "id", description = "Unique identifier of the related site entity within the server", required = false)
  public String getId() {
    return id;
  }
  ...
  public GeographicSiteRelationshipMVO relationshipType(String relationshipType) {
