...
@JsonSubTypes({
  @JsonSubTypes.Type(value = FeatureSpecificationRelationship.class, name = "FeatureSpecificationRelationship")
})
...
public class FeatureSpecificationRelationship {
  ...
  */
  ...
  public FeatureSpecificationRelationship atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public FeatureSpecificationRelationship relationshipType(RelationshipTypeEnum relationshipType) {
  ...
  */
  ...
  @Schema(name = "relationshipType", description = "This is the type of the feature specification relationship.", required = false)
  ...
  */
  ...
  @Schema(name = "name", description = "This is the name of the target feature specification.", required = false)
