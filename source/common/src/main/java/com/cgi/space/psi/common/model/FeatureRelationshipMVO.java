...
@JsonSubTypes({
  @JsonSubTypes.Type(value = FeatureRelationshipMVO.class, name = "FeatureRelationship")
})

@JsonTypeName("FeatureRelationship_MVO")
...
public class FeatureRelationshipMVO {
  ...
  */
  ...
  public FeatureRelationshipMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public FeatureRelationshipMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public FeatureRelationshipMVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  @Schema(name = "name", description = "This is the name of the target feature.", required = false)
  ...
  public FeatureRelationshipMVO atReferredType(String atReferredType) {
  ...
  */
  ...
  @Schema(name = "relationshipType", description = "This is the type of the feature relationship.", required = false)
