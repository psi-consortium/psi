...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ConnectionPointSpecificationRef.class, name = "ConnectionPointSpecificationRef")
})
...
public class ConnectionPointSpecificationRef {
  ...
  */
  ...
  public ConnectionPointSpecificationRef atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  @Schema(name = "version", description = "Connection point specification version", required = false)
