...
@JsonSubTypes({
  @JsonSubTypes.Type(value = CustomerBillFVO.class, name = "CustomerBill")
})

@JsonTypeName("CustomerBill_FVO")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class CustomerBillFVO {
  ...
  public CustomerBillFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  */
  ...
  public CustomerBillFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public CustomerBillFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public CustomerBillFVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public CustomerBillFVO amountDue(Money amountDue) {
  ...
  */
  ...
  public CustomerBillFVO appliedPayment(List<AppliedPayment> appliedPayment) {
    this.appliedPayment = appliedPayment;
    return this;
  }

  public CustomerBillFVO addAppliedPaymentItem(AppliedPayment appliedPaymentItem) {
  ...
  */
  ...
  public CustomerBillFVO billDate(OffsetDateTime billDate) {
  ...
  */
  ...
  public CustomerBillFVO billDocument(List<AttachmentOrDocumentRef> billDocument) {
    this.billDocument = billDocument;
    return this;
  }

  public CustomerBillFVO addBillDocumentItem(AttachmentOrDocumentRef billDocumentItem) {
  ...
  */
  ...
  public CustomerBillFVO billNo(String billNo) {
    this.billNo = billNo;
    return this;
  }
  ...
  */
  ...
  public CustomerBillFVO billingAccount(BillingAccountRef billingAccount) {
  ...
  */
  ...
  public CustomerBillFVO billingPeriod(TimePeriod billingPeriod) {
  ...
  */
  ...
  public CustomerBillFVO billCycle(BillCycleRef billCycle) {
  ...
  */
  ...
  public CustomerBillFVO category(String category) {
  ...
  */
  ...
  public CustomerBillFVO financialAccount(FinancialAccountRef financialAccount) {
  ...
  */
  ...
  public CustomerBillFVO lastUpdate(OffsetDateTime lastUpdate) {
  ...
  */
  ...
  public CustomerBillFVO nextBillDate(OffsetDateTime nextBillDate) {
  ...
  */
  ...
  public CustomerBillFVO paymentDueDate(OffsetDateTime paymentDueDate) {
  ...
  */
  ...
  public CustomerBillFVO paymentMethod(PaymentMethodRef paymentMethod) {
  ...
  */
  ...
  public CustomerBillFVO relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public CustomerBillFVO addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  */
  ...
  public CustomerBillFVO remainingAmount(Money remainingAmount) {
  ...
  */
  ...
  public CustomerBillFVO runType(CustomerBillRunType runType) {
  ...
  */
  ...
  public CustomerBillFVO taxExcludedAmount(Money taxExcludedAmount) {
  ...
  */
  ...
  public CustomerBillFVO taxIncludedAmount(Money taxIncludedAmount) {
  ...
  */
  ...
  public CustomerBillFVO taxItem(List<TaxItem> taxItem) {
    this.taxItem = taxItem;
    return this;
  }

  public CustomerBillFVO addTaxItemItem(TaxItem taxItemItem) {
  ...
  */
  ...
  public CustomerBillFVO state(CustomerBillStateType state) {
    this.state = state;
    return this;
  }
  ...
  */
  ...
  public CustomerBillFVO productOrder(ProductOrderRef productOrder) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    CustomerBillFVO customerBillFVO = (CustomerBillFVO) o;
    return Objects.equals(this.atType, customerBillFVO.atType) &&
        Objects.equals(this.atBaseType, customerBillFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, customerBillFVO.atSchemaLocation) &&
        Objects.equals(this.id, customerBillFVO.id) &&
        Objects.equals(this.amountDue, customerBillFVO.amountDue) &&
        Objects.equals(this.appliedPayment, customerBillFVO.appliedPayment) &&
        Objects.equals(this.billDate, customerBillFVO.billDate) &&
        Objects.equals(this.billDocument, customerBillFVO.billDocument) &&
        Objects.equals(this.billNo, customerBillFVO.billNo) &&
        Objects.equals(this.billingAccount, customerBillFVO.billingAccount) &&
        Objects.equals(this.billingPeriod, customerBillFVO.billingPeriod) &&
        Objects.equals(this.billCycle, customerBillFVO.billCycle) &&
        Objects.equals(this.category, customerBillFVO.category) &&
        Objects.equals(this.financialAccount, customerBillFVO.financialAccount) &&
        Objects.equals(this.lastUpdate, customerBillFVO.lastUpdate) &&
        Objects.equals(this.nextBillDate, customerBillFVO.nextBillDate) &&
        Objects.equals(this.paymentDueDate, customerBillFVO.paymentDueDate) &&
        Objects.equals(this.paymentMethod, customerBillFVO.paymentMethod) &&
        Objects.equals(this.relatedParty, customerBillFVO.relatedParty) &&
        Objects.equals(this.remainingAmount, customerBillFVO.remainingAmount) &&
        Objects.equals(this.runType, customerBillFVO.runType) &&
        Objects.equals(this.taxExcludedAmount, customerBillFVO.taxExcludedAmount) &&
        Objects.equals(this.taxIncludedAmount, customerBillFVO.taxIncludedAmount) &&
        Objects.equals(this.taxItem, customerBillFVO.taxItem) &&
        Objects.equals(this.state, customerBillFVO.state) &&
        Objects.equals(this.productOrder, customerBillFVO.productOrder);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, amountDue, appliedPayment, billDate, billDocument, billNo, billingAccount, billingPeriod, billCycle, category, financialAccount, lastUpdate, nextBillDate, paymentDueDate, paymentMethod, relatedParty, remainingAmount, runType, taxExcludedAmount, taxIncludedAmount, taxItem, state, productOrder);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomerBillFVO {\n");
