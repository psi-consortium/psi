...
@JsonSubTypes({
  @JsonSubTypes.Type(value = FeatureRelationship.class, name = "FeatureRelationship")
})
...
public class FeatureRelationship {
  ...
  */
  ...
  public FeatureRelationship href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public FeatureRelationship atReferredType(String atReferredType) {
