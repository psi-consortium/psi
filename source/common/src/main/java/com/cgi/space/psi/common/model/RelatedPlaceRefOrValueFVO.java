...
@JsonSubTypes({
  @JsonSubTypes.Type(value = RelatedPlaceRefOrValueFVO.class, name = "RelatedPlaceRefOrValue")
})

@JsonTypeName("RelatedPlaceRefOrValue_FVO")
...
public class RelatedPlaceRefOrValueFVO {
  ...
  */
  ...
  public RelatedPlaceRefOrValueFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public RelatedPlaceRefOrValueFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "place", required = true)
