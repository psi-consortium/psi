...
import com.cgi.space.psi.common.model.ResourceGraphSpecificationRelationship;
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ResourceGraphSpecification.class, name = "ResourceGraphSpecification")
})
...
public class ResourceGraphSpecification {
  ...
  @Valid
  private List<ResourceGraphSpecificationRelationship> graphSpecificationRelationship = null;

  @JsonProperty("connectionSpecification")
  @Valid
  private List<ConnectionSpecification> connectionSpecification = null;
  ...
  */
  ...
  public ResourceGraphSpecification atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  @Schema(name = "name", description = "Descriptive name for the resource graph specification.", required = false)
  ...
  */
  ...
  @Schema(name = "description", description = "Description of the resource graph specification.", required = false)
  ...
  public ResourceGraphSpecification graphSpecificationRelationship(List<ResourceGraphSpecificationRelationship> graphSpecificationRelationship) {
  ...
  */
  @Valid 
  @Schema(name = "graphSpecificationRelationship", description = "Relationships to other resource graph specifications.", required = false)
  public List<ResourceGraphSpecificationRelationship> getGraphSpecificationRelationship() {
    return graphSpecificationRelationship;
  }

  public void setGraphSpecificationRelationship(List<ResourceGraphSpecificationRelationship> graphSpecificationRelationship) {
    this.graphSpecificationRelationship = graphSpecificationRelationship;
  }
  ...
  */
  @Valid 
  @Schema(name = "connectionSpecification", description = "Resource graph edge specifications.", required = false)
