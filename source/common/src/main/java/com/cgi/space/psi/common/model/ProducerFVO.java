...
public class ProducerFVO extends PartyRoleFVO implements PartyOrPartyRoleFVO {
  ...
  public ProducerFVO account(List<AccountRefFVO> account) {
  ...
  public ProducerFVO agreement(List<AgreementRefFVO> agreement) {
  ...
  public ProducerFVO paymentMethod(List<PaymentMethodRefFVO> paymentMethod) {
