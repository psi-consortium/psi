...
@JsonSubTypes({
  @JsonSubTypes.Type(value = RelatedResourceOrderItemFVO.class, name = "RelatedResourceOrderItem")
})

@JsonTypeName("RelatedResourceOrderItem_FVO")
...
public class RelatedResourceOrderItemFVO {
  ...
  */
  ...
  public RelatedResourceOrderItemFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public RelatedResourceOrderItemFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public RelatedResourceOrderItemFVO atReferredType(String atReferredType) {
