...
@JsonSubTypes({
  @JsonSubTypes.Type(value = GeographicSubAddressMVO.class, name = "GeographicSubAddress")
})

@JsonTypeName("GeographicSubAddress_MVO")
...
public class GeographicSubAddressMVO {
  ...
  @Valid
  private List<GeographicSubAddressUnitMVO> subUnit = null;
  ...
  */
  ...
  public GeographicSubAddressMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public GeographicSubAddressMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public GeographicSubAddressMVO buildingName(String buildingName) {
  ...
  */
  ...
  public GeographicSubAddressMVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public GeographicSubAddressMVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public GeographicSubAddressMVO levelNumber(String levelNumber) {
  ...
  */
  ...
  public GeographicSubAddressMVO levelType(String levelType) {
  ...
  */
  ...
  public GeographicSubAddressMVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public GeographicSubAddressMVO privateStreetName(String privateStreetName) {
  ...
  */
  ...
  public GeographicSubAddressMVO privateStreetNumber(String privateStreetNumber) {
  ...
  */
  ...
  public GeographicSubAddressMVO subAddressType(String subAddressType) {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, buildingName, href, id, levelNumber, levelType, name, privateStreetName, privateStreetNumber, subUnit, subAddressType);
  }
