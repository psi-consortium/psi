...
@JsonSubTypes({
  @JsonSubTypes.Type(value = OrganizationIdentificationFVO.class, name = "OrganizationIdentification")
})

@JsonTypeName("OrganizationIdentification_FVO")
...
public class OrganizationIdentificationFVO {
  ...
  */
  ...
  public OrganizationIdentificationFVO attachment(AttachmentOrDocumentRef attachment) {
