...
@JsonSubTypes({
  @JsonSubTypes.Type(value = RelatedPartyRefOrPartyRoleRefFVO.class, name = "RelatedPartyRefOrPartyRoleRef")
})

@JsonTypeName("RelatedPartyRefOrPartyRoleRef_FVO")
...
public class RelatedPartyRefOrPartyRoleRefFVO {
  ...
  */
  ...
  public RelatedPartyRefOrPartyRoleRefFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public RelatedPartyRefOrPartyRoleRefFVO atSchemaLocation(String atSchemaLocation) {
