...
@JsonSubTypes({
  @JsonSubTypes.Type(value = FeatureSpecificationMVO.class, name = "FeatureSpecification")
})

@JsonTypeName("FeatureSpecification_MVO")
...
public class FeatureSpecificationMVO {
  ...
  @Valid
  private List<FeatureSpecificationRelationshipMVO> featureSpecRelationship = null;
  ...
  @Valid
  private List<CharacteristicSpecificationMVO> featureSpecCharacteristic = null;
  ...
  */
  ...
  public FeatureSpecificationMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public FeatureSpecificationMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public FeatureSpecificationMVO version(String version) {
  ...
  */
  ...
  public FeatureSpecificationMVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public FeatureSpecificationMVO isBundle(Boolean isBundle) {
  ...
  */
  ...
  public FeatureSpecificationMVO validFor(TimePeriod validFor) {
  ...
  */
  ...
  public FeatureSpecificationMVO isEnabled(Boolean isEnabled) {
