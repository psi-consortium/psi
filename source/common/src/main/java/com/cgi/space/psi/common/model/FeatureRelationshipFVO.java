...
@JsonSubTypes({
  @JsonSubTypes.Type(value = FeatureRelationshipFVO.class, name = "FeatureRelationship")
})

@JsonTypeName("FeatureRelationship_FVO")
...
public class FeatureRelationshipFVO {
  ...
  */
  ...
  public FeatureRelationshipFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public FeatureRelationshipFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public FeatureRelationshipFVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public FeatureRelationshipFVO atReferredType(String atReferredType) {
  ...
  */
  @NotNull 
  @Schema(name = "relationshipType", description = "This is the type of the feature relationship.", required = true)
