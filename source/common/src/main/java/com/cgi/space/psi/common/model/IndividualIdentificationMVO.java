...
@JsonSubTypes({
  @JsonSubTypes.Type(value = IndividualIdentificationMVO.class, name = "IndividualIdentification")
})

@JsonTypeName("IndividualIdentification_MVO")
...
public class IndividualIdentificationMVO {
  ...
  */
  ...
  public IndividualIdentificationMVO attachment(AttachmentOrDocumentRef attachment) {
