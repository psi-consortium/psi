...
import com.cgi.space.psi.common.model.MarketSegmentRefFVO;
...
import com.cgi.space.psi.common.model.ProductOfferingTermFVO;
import com.cgi.space.psi.common.model.ProductSpecificationCharacteristicValueUseFVO;
...
import com.cgi.space.psi.common.model.ResourceCandidateRefFVO;
import com.cgi.space.psi.common.model.ServiceCandidateRefFVO;
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ProductOfferingFVO.class, name = "ProductOffering")
})

@JsonTypeName("ProductOffering_FVO")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class ProductOfferingFVO {
  ...
  @JsonProperty("place")
  @Valid
  private List<PlaceRefFVO> place = null;
  ...
  private ServiceCandidateRefFVO serviceCandidate;
  ...
  private ResourceCandidateRefFVO resourceCandidate;

  @JsonProperty("productOfferingTerm")
  @Valid
  private List<ProductOfferingTermFVO> productOfferingTerm = null;
  ...
  @Valid
  private List<BundledProductOfferingFVO> bundledProductOffering = null;
  ...
  @Valid
  private List<MarketSegmentRefFVO> marketSegment = null;

  @JsonProperty("productOfferingRelationship")
  @Valid
  private List<ProductOfferingRelationshipFVO> productOfferingRelationship = null;

  @JsonProperty("productOfferingCharacteristic")
  @Valid
  private List<CharacteristicSpecificationFVO> productOfferingCharacteristic = null;

  @JsonProperty("prodSpecCharValueUse")
  @Valid
  private List<ProductSpecificationCharacteristicValueUseFVO> prodSpecCharValueUse = null;

  @JsonProperty("policy")
  @Valid
  private List<PolicyRefFVO> policy = null;

  @JsonProperty("allowedAction")
  @Valid
  private List<AllowedProductActionFVO> allowedAction = null;
  ...
  public ProductOfferingFVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  */
  ...
  public ProductOfferingFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public ProductOfferingFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public ProductOfferingFVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public ProductOfferingFVO description(String description) {
  ...
  */
  ...
  public ProductOfferingFVO isBundle(Boolean isBundle) {
  ...
  */
  ...
  public ProductOfferingFVO isSellable(Boolean isSellable) {
  ...
  */
  ...
  public ProductOfferingFVO statusReason(String statusReason) {
  ...
  */
  ...
  public ProductOfferingFVO validFor(TimePeriod validFor) {
  ...
  */
  ...
  public ProductOfferingFVO version(String version) {
  ...
  */
  ...
  public ProductOfferingFVO place(List<PlaceRefFVO> place) {
    this.place = place;
    return this;
  }

  public ProductOfferingFVO addPlaceItem(PlaceRefFVO placeItem) {
    if (this.place == null) {
  ...
  */
  ...
  public List<PlaceRefFVO> getPlace() {
    return place;
  }

  public void setPlace(List<PlaceRefFVO> place) {
    this.place = place;
  }

  public ProductOfferingFVO serviceLevelSpecification(ServiceLevelSpecificationRef serviceLevelSpecification) {
  ...
  */
  ...
  public ProductOfferingFVO channel(List<ChannelRefFVO> channel) {
    this.channel = channel;
    return this;
  }

  public ProductOfferingFVO addChannelItem(ChannelRefFVO channelItem) {
  ...
  */
  ...
  public ProductOfferingFVO serviceCandidate(ServiceCandidateRefFVO serviceCandidate) {
  ...
  */
  ...
  public ServiceCandidateRefFVO getServiceCandidate() {
    return serviceCandidate;
  }

  public void setServiceCandidate(ServiceCandidateRefFVO serviceCandidate) {
    this.serviceCandidate = serviceCandidate;
  }

  public ProductOfferingFVO category(List<CategoryRefFVO> category) {
    this.category = category;
    return this;
  }

  public ProductOfferingFVO addCategoryItem(CategoryRefFVO categoryItem) {
  ...
  */
  ...
  public ProductOfferingFVO resourceCandidate(ResourceCandidateRefFVO resourceCandidate) {
  ...
  */
  ...
  public ResourceCandidateRefFVO getResourceCandidate() {
    return resourceCandidate;
  }

  public void setResourceCandidate(ResourceCandidateRefFVO resourceCandidate) {
    this.resourceCandidate = resourceCandidate;
  }

  public ProductOfferingFVO productOfferingTerm(List<ProductOfferingTermFVO> productOfferingTerm) {
    this.productOfferingTerm = productOfferingTerm;
    return this;
  }

  public ProductOfferingFVO addProductOfferingTermItem(ProductOfferingTermFVO productOfferingTermItem) {
  ...
  */
  ...
  public List<ProductOfferingTermFVO> getProductOfferingTerm() {
    return productOfferingTerm;
  }

  public void setProductOfferingTerm(List<ProductOfferingTermFVO> productOfferingTerm) {
    this.productOfferingTerm = productOfferingTerm;
  }

  public ProductOfferingFVO productOfferingPrice(List<ProductOfferingPrice> productOfferingPrice) {
    this.productOfferingPrice = productOfferingPrice;
    return this;
  }

  public ProductOfferingFVO addProductOfferingPriceItem(ProductOfferingPrice productOfferingPriceItem) {
  ...
  */
  ...
  public ProductOfferingFVO agreement(List<AgreementRefFVO> agreement) {
    this.agreement = agreement;
    return this;
  }

  public ProductOfferingFVO addAgreementItem(AgreementRefFVO agreementItem) {
  ...
  */
  ...
  public ProductOfferingFVO bundledProductOffering(List<BundledProductOfferingFVO> bundledProductOffering) {
    this.bundledProductOffering = bundledProductOffering;
    return this;
  }

  public ProductOfferingFVO addBundledProductOfferingItem(BundledProductOfferingFVO bundledProductOfferingItem) {
  ...
  */
  ...
  public List<BundledProductOfferingFVO> getBundledProductOffering() {
    return bundledProductOffering;
  }

  public void setBundledProductOffering(List<BundledProductOfferingFVO> bundledProductOffering) {
    this.bundledProductOffering = bundledProductOffering;
  }

  public ProductOfferingFVO bundledGroupProductOffering(List<BundledGroupProductOffering> bundledGroupProductOffering) {
    this.bundledGroupProductOffering = bundledGroupProductOffering;
    return this;
  }

  public ProductOfferingFVO addBundledGroupProductOfferingItem(BundledGroupProductOffering bundledGroupProductOfferingItem) {
  ...
  */
  ...
  public ProductOfferingFVO attachment(List<AttachmentOrDocumentRef> attachment) {
    this.attachment = attachment;
    return this;
  }

  public ProductOfferingFVO addAttachmentItem(AttachmentOrDocumentRef attachmentItem) {
  ...
  */
  ...
  public ProductOfferingFVO marketSegment(List<MarketSegmentRefFVO> marketSegment) {
    this.marketSegment = marketSegment;
    return this;
  }

  public ProductOfferingFVO addMarketSegmentItem(MarketSegmentRefFVO marketSegmentItem) {
  ...
  */
  ...
  public List<MarketSegmentRefFVO> getMarketSegment() {
    return marketSegment;
  }

  public void setMarketSegment(List<MarketSegmentRefFVO> marketSegment) {
    this.marketSegment = marketSegment;
  }

  public ProductOfferingFVO productOfferingRelationship(List<ProductOfferingRelationshipFVO> productOfferingRelationship) {
    this.productOfferingRelationship = productOfferingRelationship;
    return this;
  }

  public ProductOfferingFVO addProductOfferingRelationshipItem(ProductOfferingRelationshipFVO productOfferingRelationshipItem) {
  ...
  */
  ...
  public List<ProductOfferingRelationshipFVO> getProductOfferingRelationship() {
    return productOfferingRelationship;
  }

  public void setProductOfferingRelationship(List<ProductOfferingRelationshipFVO> productOfferingRelationship) {
    this.productOfferingRelationship = productOfferingRelationship;
  }

  public ProductOfferingFVO productOfferingCharacteristic(List<CharacteristicSpecificationFVO> productOfferingCharacteristic) {
    this.productOfferingCharacteristic = productOfferingCharacteristic;
    return this;
  }

  public ProductOfferingFVO addProductOfferingCharacteristicItem(CharacteristicSpecificationFVO productOfferingCharacteristicItem) {
  ...
  */
  ...
  public List<CharacteristicSpecificationFVO> getProductOfferingCharacteristic() {
    return productOfferingCharacteristic;
  }

  public void setProductOfferingCharacteristic(List<CharacteristicSpecificationFVO> productOfferingCharacteristic) {
    this.productOfferingCharacteristic = productOfferingCharacteristic;
  }

  public ProductOfferingFVO prodSpecCharValueUse(List<ProductSpecificationCharacteristicValueUseFVO> prodSpecCharValueUse) {
    this.prodSpecCharValueUse = prodSpecCharValueUse;
    return this;
  }

  public ProductOfferingFVO addProdSpecCharValueUseItem(ProductSpecificationCharacteristicValueUseFVO prodSpecCharValueUseItem) {
  ...
  */
  ...
  public List<ProductSpecificationCharacteristicValueUseFVO> getProdSpecCharValueUse() {
    return prodSpecCharValueUse;
  }

  public void setProdSpecCharValueUse(List<ProductSpecificationCharacteristicValueUseFVO> prodSpecCharValueUse) {
    this.prodSpecCharValueUse = prodSpecCharValueUse;
  }

  public ProductOfferingFVO policy(List<PolicyRefFVO> policy) {
    this.policy = policy;
    return this;
  }

  public ProductOfferingFVO addPolicyItem(PolicyRefFVO policyItem) {
    if (this.policy == null) {
  ...
  */
  ...
  public List<PolicyRefFVO> getPolicy() {
    return policy;
  }

  public void setPolicy(List<PolicyRefFVO> policy) {
    this.policy = policy;
  }

  public ProductOfferingFVO allowedAction(List<AllowedProductActionFVO> allowedAction) {
    this.allowedAction = allowedAction;
    return this;
  }

  public ProductOfferingFVO addAllowedActionItem(AllowedProductActionFVO allowedActionItem) {
  ...
  */
  ...
  public List<AllowedProductActionFVO> getAllowedAction() {
    return allowedAction;
  }

  public void setAllowedAction(List<AllowedProductActionFVO> allowedAction) {
    this.allowedAction = allowedAction;
  }

  public ProductOfferingFVO lastUpdate(OffsetDateTime lastUpdate) {
  ...
  */
  ...
  public ProductOfferingFVO lifecycleStatus(String lifecycleStatus) {
  ...
  */
  @NotNull 
  @Schema(name = "lifecycleStatus", description = "Used to indicate the current lifecycle status", required = true)
  ...
  public ProductOfferingFVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  @NotNull 
  @Schema(name = "name", description = "Name of the productOffering", required = true)
  ...
  public ProductOfferingFVO productSpecification(ProductSpecificationRefFVO productSpecification) {
  ...
  */
  ...
  public ProductOfferingFVO externalIdentifier(List<ExternalIdentifierFVO> externalIdentifier) {
    this.externalIdentifier = externalIdentifier;
    return this;
  }

  public ProductOfferingFVO addExternalIdentifierItem(ExternalIdentifierFVO externalIdentifierItem) {
  ...
  */
  ...
  public ProductOfferingFVO accessProbability(Integer accessProbability) {
  ...
  */
  ...
  public ProductOfferingFVO relatedParty(List<RelatedPartyRefOrPartyRoleRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ProductOfferingFVO addRelatedPartyItem(RelatedPartyRefOrPartyRoleRef relatedPartyItem) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ProductOfferingFVO productOfferingFVO = (ProductOfferingFVO) o;
    return Objects.equals(this.atType, productOfferingFVO.atType) &&
        Objects.equals(this.atBaseType, productOfferingFVO.atBaseType) &&
        Objects.equals(this.atSchemaLocation, productOfferingFVO.atSchemaLocation) &&
        Objects.equals(this.id, productOfferingFVO.id) &&
        Objects.equals(this.description, productOfferingFVO.description) &&
        Objects.equals(this.isBundle, productOfferingFVO.isBundle) &&
        Objects.equals(this.isSellable, productOfferingFVO.isSellable) &&
        Objects.equals(this.statusReason, productOfferingFVO.statusReason) &&
        Objects.equals(this.validFor, productOfferingFVO.validFor) &&
        Objects.equals(this.version, productOfferingFVO.version) &&
        Objects.equals(this.place, productOfferingFVO.place) &&
        Objects.equals(this.serviceLevelSpecification, productOfferingFVO.serviceLevelSpecification) &&
        Objects.equals(this.channel, productOfferingFVO.channel) &&
        Objects.equals(this.serviceCandidate, productOfferingFVO.serviceCandidate) &&
        Objects.equals(this.category, productOfferingFVO.category) &&
        Objects.equals(this.resourceCandidate, productOfferingFVO.resourceCandidate) &&
        Objects.equals(this.productOfferingTerm, productOfferingFVO.productOfferingTerm) &&
        Objects.equals(this.productOfferingPrice, productOfferingFVO.productOfferingPrice) &&
        Objects.equals(this.agreement, productOfferingFVO.agreement) &&
        Objects.equals(this.bundledProductOffering, productOfferingFVO.bundledProductOffering) &&
        Objects.equals(this.bundledGroupProductOffering, productOfferingFVO.bundledGroupProductOffering) &&
        Objects.equals(this.attachment, productOfferingFVO.attachment) &&
        Objects.equals(this.marketSegment, productOfferingFVO.marketSegment) &&
        Objects.equals(this.productOfferingRelationship, productOfferingFVO.productOfferingRelationship) &&
        Objects.equals(this.productOfferingCharacteristic, productOfferingFVO.productOfferingCharacteristic) &&
        Objects.equals(this.prodSpecCharValueUse, productOfferingFVO.prodSpecCharValueUse) &&
        Objects.equals(this.policy, productOfferingFVO.policy) &&
        Objects.equals(this.allowedAction, productOfferingFVO.allowedAction) &&
        Objects.equals(this.lastUpdate, productOfferingFVO.lastUpdate) &&
        Objects.equals(this.lifecycleStatus, productOfferingFVO.lifecycleStatus) &&
        Objects.equals(this.name, productOfferingFVO.name) &&
        Objects.equals(this.productSpecification, productOfferingFVO.productSpecification) &&
        Objects.equals(this.externalIdentifier, productOfferingFVO.externalIdentifier) &&
        Objects.equals(this.accessProbability, productOfferingFVO.accessProbability) &&
        Objects.equals(this.relatedParty, productOfferingFVO.relatedParty);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, description, isBundle, isSellable, statusReason, validFor, version, place, serviceLevelSpecification, channel, serviceCandidate, category, resourceCandidate, productOfferingTerm, productOfferingPrice, agreement, bundledProductOffering, bundledGroupProductOffering, attachment, marketSegment, productOfferingRelationship, productOfferingCharacteristic, prodSpecCharValueUse, policy, allowedAction, lastUpdate, lifecycleStatus, name, productSpecification, externalIdentifier, accessProbability, relatedParty);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductOfferingFVO {\n");
