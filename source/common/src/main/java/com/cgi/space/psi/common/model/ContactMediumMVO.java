...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = EmailContactMediumMVO.class, name = "EmailContactMedium_MVO"),
  @JsonSubTypes.Type(value = FaxContactMediumMVO.class, name = "FaxContactMedium"),
  @JsonSubTypes.Type(value = FaxContactMediumMVO.class, name = "FaxContactMedium_MVO"),
  @JsonSubTypes.Type(value = GeographicAddressContactMediumMVO.class, name = "GeographicAddressContactMedium"),
  @JsonSubTypes.Type(value = GeographicAddressContactMediumMVO.class, name = "GeographicAddressContactMedium_MVO"),
  @JsonSubTypes.Type(value = PhoneContactMediumMVO.class, name = "PhoneContactMedium"),
  @JsonSubTypes.Type(value = PhoneContactMediumMVO.class, name = "PhoneContactMedium_MVO"),
  @JsonSubTypes.Type(value = SocialContactMediumMVO.class, name = "SocialContactMedium"),
  @JsonSubTypes.Type(value = SocialContactMediumMVO.class, name = "SocialContactMedium_MVO")
})

@JsonTypeName("ContactMedium_MVO")
