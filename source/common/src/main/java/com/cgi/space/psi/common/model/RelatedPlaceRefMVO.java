...
@JsonSubTypes({
  @JsonSubTypes.Type(value = RelatedPlaceRefMVO.class, name = "RelatedPlaceRef")
})

@JsonTypeName("RelatedPlaceRef_MVO")
...
public class RelatedPlaceRefMVO {
  ...
  */
  ...
  public RelatedPlaceRefMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public RelatedPlaceRefMVO atSchemaLocation(String atSchemaLocation) {
