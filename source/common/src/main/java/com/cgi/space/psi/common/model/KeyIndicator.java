...
/**
 * KeyIndicators are defined in terms of parameters and metrics, thresholds, and tolerances  associated with the parameters.
 */
@com.fasterxml.jackson.annotation.JsonFilter(com.cgi.space.psi.common.config.DynamicJacksonFilterProvider.NAME)

@Schema(name = "KeyIndicator", description = "KeyIndicators are defined in terms of parameters and metrics, thresholds, and tolerances  associated with the parameters.")
...
public class KeyIndicator {
  ...
  public KeyIndicator href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public KeyIndicator id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public KeyIndicator name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public KeyIndicator category(String category) {
  ...
  */
  ...
  public KeyIndicator isBundled(Boolean isBundled) {
  ...
  */
  ...
  public KeyIndicator transformationAlgorithmOfKQI(String transformationAlgorithmOfKQI) {
  ...
  */
  ...
  public KeyIndicator indicatorType(IndicatorTypeEnum indicatorType) {
  ...
  */
  ...
  public KeyIndicator validFor(TimePeriod validFor) {
  ...
  */
  ...
  public KeyIndicator keyIndicatorRelationship(List<KeyIndicatorRelationship> keyIndicatorRelationship) {
    this.keyIndicatorRelationship = keyIndicatorRelationship;
    return this;
  }

  public KeyIndicator addKeyIndicatorRelationshipItem(KeyIndicatorRelationship keyIndicatorRelationshipItem) {
  ...
  */
  ...
  public KeyIndicator relatedEntity(List<RelatedEntity> relatedEntity) {
    this.relatedEntity = relatedEntity;
    return this;
  }

  public KeyIndicator addRelatedEntityItem(RelatedEntity relatedEntityItem) {
  ...
  */
  ...
  public KeyIndicator atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  */
  ...
  public KeyIndicator atBaseType(String atBaseType) {
  ...
  */
  ...
  public KeyIndicator atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    KeyIndicator keyIndicator = (KeyIndicator) o;
    return Objects.equals(this.href, keyIndicator.href) &&
        Objects.equals(this.id, keyIndicator.id) &&
        Objects.equals(this.name, keyIndicator.name) &&
        Objects.equals(this.category, keyIndicator.category) &&
        Objects.equals(this.isBundled, keyIndicator.isBundled) &&
        Objects.equals(this.transformationAlgorithmOfKQI, keyIndicator.transformationAlgorithmOfKQI) &&
        Objects.equals(this.indicatorType, keyIndicator.indicatorType) &&
        Objects.equals(this.validFor, keyIndicator.validFor) &&
        Objects.equals(this.keyIndicatorRelationship, keyIndicator.keyIndicatorRelationship) &&
        Objects.equals(this.relatedEntity, keyIndicator.relatedEntity) &&
        Objects.equals(this.atType, keyIndicator.atType) &&
        Objects.equals(this.atBaseType, keyIndicator.atBaseType) &&
        Objects.equals(this.atSchemaLocation, keyIndicator.atSchemaLocation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(href, id, name, category, isBundled, transformationAlgorithmOfKQI, indicatorType, validFor, keyIndicatorRelationship, relatedEntity, atType, atBaseType, atSchemaLocation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeyIndicator {\n");
