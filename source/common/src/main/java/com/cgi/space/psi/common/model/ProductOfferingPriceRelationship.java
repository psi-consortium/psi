...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ProductOfferingPriceRelationship.class, name = "ProductOfferingPriceRelationship")
})
...
public class ProductOfferingPriceRelationship {
  ...
  */
  ...
  public ProductOfferingPriceRelationship atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, productOfferingPriceRelationship.atType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, href, id, name, atReferredType, role, relationshipType, version);
  }
