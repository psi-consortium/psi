...
@Schema(name = "ResumePerformanceJob_Common", description = "Request for resumption of an existing Performance Job")
@JsonTypeName("ResumePerformanceJob_Common")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class ResumePerformanceJobCommon {
  ...
  public ResumePerformanceJobCommon performanceJob(PerformanceJobRef performanceJob) {
  ...
  */
  ...
  public ResumePerformanceJobCommon resumptionReason(String resumptionReason) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ResumePerformanceJobCommon resumePerformanceJobCommon = (ResumePerformanceJobCommon) o;
    return Objects.equals(this.performanceJob, resumePerformanceJobCommon.performanceJob) &&
        Objects.equals(this.resumptionReason, resumePerformanceJobCommon.resumptionReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumePerformanceJobCommon {\n");
