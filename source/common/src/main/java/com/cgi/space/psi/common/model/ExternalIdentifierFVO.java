...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ExternalIdentifierFVO.class, name = "ExternalIdentifier")
})

@JsonTypeName("ExternalIdentifier_FVO")
...
public class ExternalIdentifierFVO {
  ...
  */
  @NotNull 
  @Schema(name = "id", description = "identification of the entity within the external system.", required = true)
  public String getId() {
    return id;
  }
