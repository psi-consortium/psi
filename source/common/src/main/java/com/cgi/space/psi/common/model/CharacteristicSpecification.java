...
@JsonSubTypes({
  @JsonSubTypes.Type(value = CharacteristicSpecification.class, name = "CharacteristicSpecification")
})
...
public class CharacteristicSpecification {
  ...
  */
  ...
  public CharacteristicSpecification atBaseType(String atBaseType) {
  ...
  */
  ...
  public CharacteristicSpecification atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public CharacteristicSpecification atValueSchemaLocation(String atValueSchemaLocation) {
