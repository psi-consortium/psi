...
@JsonSubTypes({
  @JsonSubTypes.Type(value = AppointmentRef.class, name = "AppointmentRef")
})
...
public class AppointmentRef {
  ...
  */
  ...
  public AppointmentRef atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public AppointmentRef href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public AppointmentRef name(String name) {
    this.name = name;
    return this;
  }
