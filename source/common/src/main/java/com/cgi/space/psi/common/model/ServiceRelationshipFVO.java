...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ServiceRelationshipFVO.class, name = "ServiceRelationship")
})

@JsonTypeName("ServiceRelationship_FVO")
...
public class ServiceRelationshipFVO {
  ...
  @Valid
  private List<CharacteristicFVO> serviceRelationshipCharacteristic = null;
  ...
  */
  ...
  public ServiceRelationshipFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public ServiceRelationshipFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public ServiceRelationshipFVO service(ServiceRefOrValueFVO service) {
