...
@JsonSubTypes({
  @JsonSubTypes.Type(value = TaxExemptionCertificate.class, name = "TaxExemptionCertificate")
})
...
public class TaxExemptionCertificate {
  ...
  */
  ...
  public TaxExemptionCertificate attachment(AttachmentOrDocumentRef attachment) {
