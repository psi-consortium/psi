...
@Schema(name = "PerformanceProfileValue", description = "Direct assignment of values defined by PerformanceProfile type to PerformanceJob object. Necessary when PerformanceJob is created without reference to PerformanceProfile.")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class PerformanceProfileValue {
  ...
  public PerformanceProfileValue granularity(Interval granularity) {
  ...
  */
  ...
  public PerformanceProfileValue jobPriority(Integer jobPriority) {
  ...
  */
  ...
  public PerformanceProfileValue jobType(JobType jobType) {
  ...
  */
  @NotNull @Valid 
  @Schema(name = "jobType", required = true)
  ...
  public PerformanceProfileValue outputFormat(OutputFormat outputFormat) {
  ...
  */
  ...
  public PerformanceProfileValue reportingPeriod(Interval reportingPeriod) {
  ...
  */
  ...
  public PerformanceProfileValue resultFormat(ResultFormat resultFormat) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PerformanceProfileValue performanceProfileValue = (PerformanceProfileValue) o;
    return Objects.equals(this.granularity, performanceProfileValue.granularity) &&
        Objects.equals(this.jobPriority, performanceProfileValue.jobPriority) &&
        Objects.equals(this.jobType, performanceProfileValue.jobType) &&
        Objects.equals(this.outputFormat, performanceProfileValue.outputFormat) &&
        Objects.equals(this.reportingPeriod, performanceProfileValue.reportingPeriod) &&
        Objects.equals(this.resultFormat, performanceProfileValue.resultFormat);
  }

  @Override
  public int hashCode() {
    return Objects.hash(granularity, jobPriority, jobType, outputFormat, reportingPeriod, resultFormat);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PerformanceProfileValue {\n");
