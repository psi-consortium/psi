...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = ProductRefMVO.class, name = "ProductRef_MVO"),
  @JsonSubTypes.Type(value = ProductMVO.class, name = "Product_MVO")
})

@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public interface ProductRefOrValueMVO {
