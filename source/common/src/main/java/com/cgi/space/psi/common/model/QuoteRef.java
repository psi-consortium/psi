...
@Schema(name = "QuoteRef", description = "Quote reference. It's a Quote that has been executed previously.")
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = QuoteRef.class, name = "QuoteRef")
})
...
public class QuoteRef {
  ...
  */
  ...
  public QuoteRef atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, quoteRef.atType) &&
        ...
        Objects.equals(this.id, quoteRef.id) &&
