...
@JsonSubTypes({
  @JsonSubTypes.Type(value = TaxExemptionCertificateMVO.class, name = "TaxExemptionCertificate")
})

@JsonTypeName("TaxExemptionCertificate_MVO")
...
public class TaxExemptionCertificateMVO {
  ...
  @Valid
  private List<TaxDefinitionMVO> taxDefinition = null;
  ...
  */
  ...
  public TaxExemptionCertificateMVO attachment(AttachmentOrDocumentRef attachment) {
