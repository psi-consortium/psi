...
@JsonSubTypes({
  @JsonSubTypes.Type(value = OrganizationIdentificationMVO.class, name = "OrganizationIdentification")
})

@JsonTypeName("OrganizationIdentification_MVO")
...
public class OrganizationIdentificationMVO {
  ...
  */
  ...
  public OrganizationIdentificationMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public OrganizationIdentificationMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  @Schema(name = "issuingAuthority", description = "Authority which has issued the identifier (chamber of commerce...)", required = false)
  ...
  */
  ...
  @Schema(name = "identificationType", description = "Type of identification information used to identify the company in a country or internationally", required = false)
  ...
  */
  ...
  public OrganizationIdentificationMVO attachment(AttachmentOrDocumentRef attachment) {
