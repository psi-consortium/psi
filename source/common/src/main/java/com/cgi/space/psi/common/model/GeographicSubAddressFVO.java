...
import com.cgi.space.psi.common.model.GeographicSubAddressUnitFVO;
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = GeographicSubAddressFVO.class, name = "GeographicSubAddress")
})

@JsonTypeName("GeographicSubAddress_FVO")
...
public class GeographicSubAddressFVO {
  ...
  @Valid
  private List<GeographicSubAddressUnitFVO> subUnit = null;
  ...
  */
  ...
  public GeographicSubAddressFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public GeographicSubAddressFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public GeographicSubAddressFVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public GeographicSubAddressFVO buildingName(String buildingName) {
  ...
  */
  ...
  public GeographicSubAddressFVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public GeographicSubAddressFVO levelNumber(String levelNumber) {
  ...
  */
  ...
  public GeographicSubAddressFVO levelType(String levelType) {
  ...
  */
  ...
  public GeographicSubAddressFVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public GeographicSubAddressFVO privateStreetName(String privateStreetName) {
  ...
  */
  ...
  public GeographicSubAddressFVO privateStreetNumber(String privateStreetNumber) {
  ...
  */
  ...
  public GeographicSubAddressFVO subAddressType(String subAddressType) {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atType, atBaseType, atSchemaLocation, id, buildingName, href, levelNumber, levelType, name, privateStreetName, privateStreetNumber, subUnit, subAddressType);
  }
