...
@JsonSubTypes({
  @JsonSubTypes.Type(value = RelatedPartyOrPartyRoleMVO.class, name = "RelatedPartyOrPartyRole")
})

@JsonTypeName("RelatedPartyOrPartyRole_MVO")
...
public class RelatedPartyOrPartyRoleMVO {
  ...
  */
  ...
  public RelatedPartyOrPartyRoleMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public RelatedPartyOrPartyRoleMVO atSchemaLocation(String atSchemaLocation) {
