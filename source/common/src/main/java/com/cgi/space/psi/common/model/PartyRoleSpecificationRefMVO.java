...
@JsonSubTypes({
  @JsonSubTypes.Type(value = PartyRoleSpecificationRefMVO.class, name = "PartyRoleSpecificationRef")
})

@JsonTypeName("PartyRoleSpecificationRef_MVO")
...
public class PartyRoleSpecificationRefMVO {
  ...
  */
  ...
  public PartyRoleSpecificationRefMVO href(URI href) {
    this.href = href;
    return this;
  }
