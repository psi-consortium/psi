...
public class EntityRelationshipMVO {
  ...
  public EntityRelationshipMVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public EntityRelationshipMVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public EntityRelationshipMVO role(String role) {
    this.role = role;
    return this;
  }
  ...
  */
  ...
  public EntityRelationshipMVO validFor(TimePeriod validFor) {
  ...
  */
  ...
  public EntityRelationshipMVO associationSpec(EntityRef associationSpec) {
  ...
  */
  ...
  public EntityRelationshipMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public EntityRelationshipMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public EntityRelationshipMVO relationshipType(String relationshipType) {
  ...
  */
  ...
  public EntityRelationshipMVO id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public EntityRelationshipMVO atReferredType(String atReferredType) {
  ...
  */
  ...
  public EntityRelationshipMVO atType(String atType) {
    this.atType = atType;
    return this;
  }
