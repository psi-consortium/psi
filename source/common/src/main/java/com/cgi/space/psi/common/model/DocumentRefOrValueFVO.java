...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = DocumentRefFVO.class, name = "DocumentRef_FVO"),
  @JsonSubTypes.Type(value = DocumentFVO.class, name = "Document_FVO")
})

@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public interface DocumentRefOrValueFVO {
