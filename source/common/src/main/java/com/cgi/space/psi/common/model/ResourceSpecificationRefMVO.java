...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ResourceSpecificationRefMVO.class, name = "ResourceSpecificationRef")
})

@JsonTypeName("ResourceSpecificationRef_MVO")
...
public class ResourceSpecificationRefMVO {
  ...
  */
  ...
  public ResourceSpecificationRefMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public ResourceSpecificationRefMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public ResourceSpecificationRefMVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public ResourceSpecificationRefMVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public ResourceSpecificationRefMVO atReferredType(String atReferredType) {
  ...
  */
  ...
  public ResourceSpecificationRefMVO version(String version) {
