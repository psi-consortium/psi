...
@JsonTypeName("GeographicAddress_FVO")
...
public class GeographicAddressFVO extends PlaceFVO implements PlaceRefOrValueFVO {
  ...
  @Valid
  private List<StandardIdentifierFVO> countryCode = null;
  ...
  private GeographicLocationRefOrValueFVO geographicLocation;

  @JsonProperty("geographicSubAddress")
  @Valid
  private List<GeographicSubAddressFVO> geographicSubAddress = null;

  @JsonProperty("geographicAddressType")
  private String geographicAddressType;

  public GeographicAddressFVO city(String city) {
    this.city = city;
    return this;
  }
  ...
  */
  ...
  public GeographicAddressFVO country(String country) {
  ...
  */
  ...
  public GeographicAddressFVO locality(String locality) {
  ...
  */
  ...
  public GeographicAddressFVO postcode(String postcode) {
  ...
  */
  ...
  public GeographicAddressFVO stateOrProvince(String stateOrProvince) {
  ...
  */
  ...
  public GeographicAddressFVO streetName(String streetName) {
  ...
  */
  ...
  public GeographicAddressFVO streetNr(String streetNr) {
  ...
  */
  ...
  public GeographicAddressFVO streetNrLast(String streetNrLast) {
  ...
  */
  ...
  public GeographicAddressFVO streetNrLastSuffix(String streetNrLastSuffix) {
  ...
  */
  ...
  public GeographicAddressFVO streetNrSuffix(String streetNrSuffix) {
  ...
  */
  ...
  public GeographicAddressFVO streetSuffix(String streetSuffix) {
  ...
  */
  ...
  public GeographicAddressFVO streetType(String streetType) {
  ...
  */
  ...
  public GeographicAddressFVO countryCode(List<StandardIdentifierFVO> countryCode) {
    this.countryCode = countryCode;
    return this;
  }

  public GeographicAddressFVO addCountryCodeItem(StandardIdentifierFVO countryCodeItem) {
  ...
  */
  ...
  public List<StandardIdentifierFVO> getCountryCode() {
    return countryCode;
  }

  public void setCountryCode(List<StandardIdentifierFVO> countryCode) {
    this.countryCode = countryCode;
  }
  ...
  */
  ...
  public GeographicAddressFVO geographicLocation(GeographicLocationRefOrValueFVO geographicLocation) {
  ...
  */
  ...
  public GeographicLocationRefOrValueFVO getGeographicLocation() {
    return geographicLocation;
  }

  public void setGeographicLocation(GeographicLocationRefOrValueFVO geographicLocation) {
    this.geographicLocation = geographicLocation;
  }
  ...
  */
  ...
  public GeographicAddressFVO geographicAddressType(String geographicAddressType) {
  ...
  */
  ...
  public GeographicAddressFVO name(String name) {
    super.setName(name);
    return this;
  }
