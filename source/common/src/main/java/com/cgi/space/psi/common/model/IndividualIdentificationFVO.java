...
@JsonSubTypes({
  @JsonSubTypes.Type(value = IndividualIdentificationFVO.class, name = "IndividualIdentification")
})

@JsonTypeName("IndividualIdentification_FVO")
...
public class IndividualIdentificationFVO {
  ...
  */
  ...
  public IndividualIdentificationFVO attachment(AttachmentOrDocumentRef attachment) {
