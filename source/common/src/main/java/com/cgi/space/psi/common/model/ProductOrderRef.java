...
@Schema(name = "ProductOrderRef", description = "A reference to an existing Product Order.")
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ProductOrderRef.class, name = "ProductOrderRef")
})
...
public class ProductOrderRef {
  ...
  */
  ...
  public ProductOrderRef href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, productOrderRef.atType) &&
