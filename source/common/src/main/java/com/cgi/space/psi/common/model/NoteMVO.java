...
@JsonSubTypes({
  @JsonSubTypes.Type(value = NoteMVO.class, name = "Note")
})

@JsonTypeName("Note_MVO")
...
public class NoteMVO {
  ...
  */
  ...
  public NoteMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public NoteMVO atSchemaLocation(String atSchemaLocation) {
