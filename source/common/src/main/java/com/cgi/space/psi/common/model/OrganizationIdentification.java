...
@JsonSubTypes({
  @JsonSubTypes.Type(value = OrganizationIdentification.class, name = "OrganizationIdentification")
})
...
public class OrganizationIdentification {
  ...
  */
  ...
  public OrganizationIdentification attachment(AttachmentOrDocumentRef attachment) {
