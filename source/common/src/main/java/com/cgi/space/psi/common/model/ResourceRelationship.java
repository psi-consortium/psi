...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ResourceRelationship.class, name = "ResourceRelationship")
})
...
public class ResourceRelationship {
  ...
  @Valid
  private List<Characteristic> resourceRelationshipCharacteristic = null;
  ...
  */
  ...
  public ResourceRelationship atBaseType(String atBaseType) {
  ...
  */
  ...
  public ResourceRelationship atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public ResourceRelationship href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public ResourceRelationship name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public ResourceRelationship atReferredType(String atReferredType) {
