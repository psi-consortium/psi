...
@Schema(name = "SuspendPerformanceJob_Common", description = "Request for suspension of an existing Performance Job")
@JsonTypeName("SuspendPerformanceJob_Common")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class SuspendPerformanceJobCommon {
  ...
  public SuspendPerformanceJobCommon performanceJob(PerformanceJobRef performanceJob) {
  ...
  */
  ...
  public SuspendPerformanceJobCommon suspensionReason(String suspensionReason) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    SuspendPerformanceJobCommon suspendPerformanceJobCommon = (SuspendPerformanceJobCommon) o;
    return Objects.equals(this.performanceJob, suspendPerformanceJobCommon.performanceJob) &&
        Objects.equals(this.suspensionReason, suspendPerformanceJobCommon.suspensionReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class SuspendPerformanceJobCommon {\n");
