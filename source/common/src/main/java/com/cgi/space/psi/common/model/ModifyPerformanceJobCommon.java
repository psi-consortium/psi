...
@Schema(name = "ModifyPerformanceJob_Common", description = "Request for modification of an existing Performance Job")
@JsonTypeName("ModifyPerformanceJob_Common")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class ModifyPerformanceJobCommon {
  ...
  public ModifyPerformanceJobCommon buyerJobId(String buyerJobId) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon consumingApplicationId(String consumingApplicationId) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon description(String description) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon fileTransferData(FileTransferData fileTransferData) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon modificationReason(String modificationReason) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon performanceJob(PerformanceJobRef performanceJob) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon performanceProfile(ModifyPerformanceJobProfileValue performanceProfile) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon producingApplicationId(String producingApplicationId) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon scheduleDefinition(ScheduleDefinition scheduleDefinition) {
  ...
  */
  ...
  public ModifyPerformanceJobCommon servicePayloadSpecificAttributes(ServicePayloadSpecificAttributes servicePayloadSpecificAttributes) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ModifyPerformanceJobCommon modifyPerformanceJobCommon = (ModifyPerformanceJobCommon) o;
    return Objects.equals(this.buyerJobId, modifyPerformanceJobCommon.buyerJobId) &&
        Objects.equals(this.consumingApplicationId, modifyPerformanceJobCommon.consumingApplicationId) &&
        Objects.equals(this.description, modifyPerformanceJobCommon.description) &&
        Objects.equals(this.fileTransferData, modifyPerformanceJobCommon.fileTransferData) &&
        Objects.equals(this.modificationReason, modifyPerformanceJobCommon.modificationReason) &&
        Objects.equals(this.performanceJob, modifyPerformanceJobCommon.performanceJob) &&
        Objects.equals(this.performanceProfile, modifyPerformanceJobCommon.performanceProfile) &&
        Objects.equals(this.producingApplicationId, modifyPerformanceJobCommon.producingApplicationId) &&
        Objects.equals(this.scheduleDefinition, modifyPerformanceJobCommon.scheduleDefinition) &&
        Objects.equals(this.servicePayloadSpecificAttributes, modifyPerformanceJobCommon.servicePayloadSpecificAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyPerformanceJobCommon {\n");
