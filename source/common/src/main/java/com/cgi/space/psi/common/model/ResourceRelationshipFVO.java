...
@JsonSubTypes({
  @JsonSubTypes.Type(value = ResourceRelationshipFVO.class, name = "ResourceRelationship")
})

@JsonTypeName("ResourceRelationship_FVO")
...
public class ResourceRelationshipFVO {
  ...
  @Valid
  private List<CharacteristicFVO> resourceRelationshipCharacteristic = null;
  ...
  */
  ...
  public ResourceRelationshipFVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public ResourceRelationshipFVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public ResourceRelationshipFVO href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public ResourceRelationshipFVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public ResourceRelationshipFVO atReferredType(String atReferredType) {
