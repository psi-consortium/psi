...
/**
 * PerformanceJobCreate
 */
@com.fasterxml.jackson.annotation.JsonFilter(com.cgi.space.psi.common.config.DynamicJacksonFilterProvider.NAME)

@JsonTypeName("PerformanceJob_Create")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class PerformanceJobCreate {
  ...
  public PerformanceJobCreate buyerJobId(String buyerJobId) {
  ...
  */
  ...
  public PerformanceJobCreate consumingApplicationId(String consumingApplicationId) {
  ...
  */
  ...
  public PerformanceJobCreate description(String description) {
  ...
  */
  ...
  public PerformanceJobCreate fileTransferData(FileTransferData fileTransferData) {
  ...
  */
  ...
  public PerformanceJobCreate performanceProfile(PerformanceProfileValue performanceProfile) {
  ...
  */
  ...
  public PerformanceJobCreate producingApplicationId(String producingApplicationId) {
  ...
  */
  ...
  public PerformanceJobCreate scheduleDefinition(ScheduleDefinition scheduleDefinition) {
  ...
  */
  ...
  public PerformanceJobCreate servicePayloadSpecificAttributes(ServicePayloadSpecificAttributes servicePayloadSpecificAttributes) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PerformanceJobCreate performanceJobCreate = (PerformanceJobCreate) o;
    return Objects.equals(this.buyerJobId, performanceJobCreate.buyerJobId) &&
        Objects.equals(this.consumingApplicationId, performanceJobCreate.consumingApplicationId) &&
        Objects.equals(this.description, performanceJobCreate.description) &&
        Objects.equals(this.fileTransferData, performanceJobCreate.fileTransferData) &&
        Objects.equals(this.performanceProfile, performanceJobCreate.performanceProfile) &&
        Objects.equals(this.producingApplicationId, performanceJobCreate.producingApplicationId) &&
        Objects.equals(this.scheduleDefinition, performanceJobCreate.scheduleDefinition) &&
        Objects.equals(this.servicePayloadSpecificAttributes, performanceJobCreate.servicePayloadSpecificAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PerformanceJobCreate {\n");
