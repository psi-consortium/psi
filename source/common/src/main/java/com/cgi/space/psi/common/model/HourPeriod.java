...
@JsonSubTypes({
  @JsonSubTypes.Type(value = HourPeriod.class, name = "HourPeriod")
})
...
public class HourPeriod {
  ...
  */
  ...
  public HourPeriod atBaseType(String atBaseType) {
  ...
  */
  ...
  public HourPeriod atSchemaLocation(String atSchemaLocation) {
