...
@JsonSubTypes({
  @JsonSubTypes.Type(value = CalendarPeriodMVO.class, name = "CalendarPeriod")
})

@JsonTypeName("CalendarPeriod_MVO")
...
public class CalendarPeriodMVO {
  ...
  @Valid
  private List<HourPeriodMVO> hourPeriod = null;
  ...
  */
  ...
  public CalendarPeriodMVO atBaseType(String atBaseType) {
  ...
  */
  ...
  public CalendarPeriodMVO atSchemaLocation(String atSchemaLocation) {
  ...
  */
  ...
  public CalendarPeriodMVO day(String day) {
    this.day = day;
    return this;
  }
  ...
  */
  ...
  public CalendarPeriodMVO timeZone(String timeZone) {
  ...
  */
  ...
  public CalendarPeriodMVO status(String status) {
    this.status = status;
    return this;
  }
