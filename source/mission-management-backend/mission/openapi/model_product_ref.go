...
func NewProductRef(id string) *ProductRef {
	this := ProductRef{}
	this.Id = id
	return &this
}
...
func (o *ProductRef) GetIdOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
	return &o.Id, true
...
func (o *ProductRef) SetId(v string) {
	o.Id = v
}

// GetHref returns the Href field value if set, zero value otherwise.
func (o *ProductRef) GetHref() string {
...
// and a boolean to check if the value has been set.
func (o *ProductRef) GetHrefOk() (*string, bool) {
	if o == nil || isNil(o.Href) {
    return nil, false
	}
	return o.Href, true
...
func (o *ProductRef) HasHref() bool {
	if o != nil && !isNil(o.Href) {
		return true
	}
...
func (o *ProductRef) SetHref(v string) {
	o.Href = &v
}
...
// and a boolean to check if the value has been set.
func (o *ProductRef) GetNameOk() (*string, bool) {
	if o == nil || isNil(o.Name) {
    return nil, false
	}
	return o.Name, true
...
func (o *ProductRef) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
func (o *ProductRef) SetName(v string) {
	o.Name = &v
}

// GetBaseType returns the BaseType field value if set, zero value otherwise.
func (o *ProductRef) GetBaseType() string {
...
// and a boolean to check if the value has been set.
func (o *ProductRef) GetBaseTypeOk() (*string, bool) {
	if o == nil || isNil(o.BaseType) {
    return nil, false
	}
...
func (o *ProductRef) HasBaseType() bool {
	if o != nil && !isNil(o.BaseType) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ProductRef) GetSchemaLocationOk() (*string, bool) {
	if o == nil || isNil(o.SchemaLocation) {
    return nil, false
	}
...
func (o *ProductRef) HasSchemaLocation() bool {
	if o != nil && !isNil(o.SchemaLocation) {
		return true
	}
...
func (o *ProductRef) SetSchemaLocation(v string) {
	o.SchemaLocation = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *ProductRef) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *ProductRef) GetTypeOk() (*string, bool) {
	if o == nil || isNil(o.Type) {
    return nil, false
	}
	return o.Type, true
...
func (o *ProductRef) HasType() bool {
	if o != nil && !isNil(o.Type) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ProductRef) GetReferredTypeOk() (*string, bool) {
	if o == nil || isNil(o.ReferredType) {
    return nil, false
	}
...
func (o *ProductRef) HasReferredType() bool {
	if o != nil && !isNil(o.ReferredType) {
		return true
	}
...
func (o *ProductRef) SetReferredType(v string) {
	o.ReferredType = &v
}
